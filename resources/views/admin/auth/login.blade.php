	...
	<div class="mx-auto my-5 card card-authentication1">
		<div class="card-body">
		 <div class="p-2 card-content">
		  ...
		  <div class="py-3 text-center card-title text-uppercase">Sign In Admin</div>
		  ...
		  <div class="py-3 text-center card-footer">
		    <p class="mb-0 text-warning">Do not have an account? <a href="{{ route('admin.ShowRegister') }}"> Sign Up here</a></p>
		  </div>
	     </div>
