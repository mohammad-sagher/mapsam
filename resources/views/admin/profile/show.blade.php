                            ...
                            <div class="tab-pane" id="edit">
                                ...
                                <form action="{{ route('admin.updateData') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9"><input class="form-control" name="address" type="text" value="{{ $profile->address ?? Auth::guard('admin')->user()->address }}"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Username</label>
                                        <div class="col-lg-9"><input class="form-control" name="username" type="text" value="{{ $profile->username ?? Auth::guard('admin')->user()->name }}"></div>
                                    </div>
                                    <div class="form-group row">
