                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3 tab-content">
                            ...
                            <div id="recent-activity" class="tab-pane fade">
                                <form action="{{ route('accountant.updateActivity') }}" method="post">
                                    @csrf
                                    @method('PUT')
                            ...
                            <div class="tab-pane" id="edit">
                                ...
                                <form action="{{ route('accountant.updateData') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9"><input class="form-control" name="address" type="text" value="{{ $profile->address ?? Auth::guard('accountant')->user()->address }}"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Username</label>
                                        <div class="col-lg-9"><input class="form-control" name="username" type="text" value="{{ $profile->username ?? Auth::guard('accountant')->user()->name }}"></div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <form  action="{{ route('accountant.updatePassword') }}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row">
